...
SELECT DATE_TRUNC('MM', D.DT)                                AS MONTH1_120
     , MASTER_BUCKET                                         AS MASTER_BUCKET_120
     , COUNT(CASE WHEN TO_DATE(WIP_START) = D.DT THEN 1 END) AS INFLOW_120
     , COUNT(CASE WHEN TO_DATE(WIP_END) = D.DT THEN 1 END)   AS OUTFLOW_120
     , INFLOW_120 - OUTFLOW_120                              AS NET_120
