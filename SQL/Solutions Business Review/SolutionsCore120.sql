WITH CASE_TABLE AS (
    ...
    ORDER BY C.PROJECT_ID
     ...
     SOLUTIONS_WORKBOOK AS (
         SELECT SOLAR_BILLING_ACCOUNT_NUMBER1 AS SOLAR_BILLING_ACCOUNT_NUMBER1_120
              , BILLING_ACCOUNT               AS BILLING_ACCOUNT_120
              , CODE_WIP_START                AS CODE_WIP_START_120
              , CREATED_DATE                  AS CREATED_DATE_120
              , WIP_START                     AS WIP_START_120
              , CODE_WIP_END                  AS CODE_WIP_END_120
              , CLOSED_DATE                   AS CLOSED_DATE_120
              , WIP_END                       AS WIP_END_120
              , CASE_NUMBER                   AS CASE_NUMBER_120
              , STATUS_NAME                   AS STATUS_NMAE_120
              , AVERAGE_GAP                   AS AVERAGE_GAP_120
              , COVERAGE                      AS COVERAGE_120
              , LAST_30_DAY_GAP               AS LAST_30_DAY_GAP_120
              , LAST_30_DAY_COVERAGE          AS LAST_30_DAY_COVERAGE_120
              , STATUS1                       AS STATUS1_120
              , SYSTEM_SIZE                   AS SYSTEM_SIZE_120
              , SYSTEM_VALUE                  AS SYSTEM_VALUE_120
              , NVL(AGE_FOR_CASE, AGE_DAYS)   AS AGE_120
              , WIP_KPI                       AS WIP_KPI_120
              , RECORD_TYPE1                  AS RECORD_TYPE1_120
              , MASTER_BUCKET                 AS MASTER_BUCKET_120
