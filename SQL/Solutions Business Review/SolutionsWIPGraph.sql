WITH CASE_TABLE AS (
    ...
    SELECT C.CASE_NUMBER
        ...
        END                                                                                            AS RECORD_PRIORITY1
         , ROW_NUMBER() OVER (PARTITION BY C.PROJECT_ID ORDER BY RECORD_PRIORITY1 ,CREATED_DATE1 DESC) AS RN
         , CASE
   ...
   , FULL_CASE AS (
    SELECT CASE_NUMBER
        ...
        END                                                                                        AS STATUS_BUCKET
         ...
         , ROW_NUMBER() OVER (PARTITION BY SOLAR_BILLING_ACCOUNT_NUMBER1 ORDER BY RECORD_PRIORITY) AS RN
