...
SELECT
	...
	,BK_INFLOW + FORE_INFLOW + NOCASE_INFLOW + DEFAULT_INFLOW + D1_INFLOW + D2_INFLOW + D4_INFLOW + D5_INFLOW AS TOTAL_INFLOW
FROM
	CORE_TABLE AS CT
WHERE
	MASTER_BUCKET IN ('BK','CORP-Default','CORP-No Case','D1','D2','D4','D5','FORE')
GROUP BY 1
ORDER BY 1