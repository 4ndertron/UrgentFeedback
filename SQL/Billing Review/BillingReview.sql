/*
 Check current list against the current backlogging. Do not audit those.
 Tyson - Do not send Envoy-R accounts if possible.
 fleet.t_invintory
 ...
 Finish the Report Card - Billing Review Objectives document.
 */